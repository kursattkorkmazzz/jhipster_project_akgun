package com.kursat.backend.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.kursat.backend.service.EmailAlreadyUsedException ||
            ex instanceof com.kursat.backend.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.kursat.backend.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.kursat.backend");
    }
}
